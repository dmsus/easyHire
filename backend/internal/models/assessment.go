...
type Assessment struct {
	...
	TimeLimit        int              `gorm:"not null;default:3600" json:"time_limit"` // seconds
...
type AssessmentCompetency struct {
	...
	Level        string  `gorm:"type:varchar(50);not null;default:'middle'" json:"level"`
...
type Invitation struct {
	BaseModel
	AssessmentID string           `gorm:"type:uuid;not null;index" json:"assessment_id"`
	CandidateID  *string          `gorm:"type:uuid;index" json:"candidate_id"` // ✅ nullable
